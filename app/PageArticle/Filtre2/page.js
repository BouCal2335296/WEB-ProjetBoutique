...
export default function PageArticle() {
    ...
    return <>
        <div className="position-relative w-100 divImageFond">
            ...
            <img src="https://projet-prog4e07.cegepjonquiere.ca/imageDecoAmb1.jpg" className="position-absolute top-0 start-0 w-100 h-100 imgGauche" alt="Gauche"/>

            {/* Image droite avec découpe diagonale */}
            <div className="position-absolute top-0 end-0 h-100 divImageSup">
                <img src="https://projet-prog4e07.cegepjonquiere.ca/imageDecoAmb2.jpg" className="w-100 h-100 imgDroite" alt="Droite"
                />
            </div>
        </div>
