                ...
                <nav className="navbar color3">
                    <div className="row container-fluid">
                        ...
                        <div className="col-3 col-md-1 d-flex justify-content-end">
                            <Link href="/" className="btn btn-outline-success">Sign in</Link>
                        </div>
                        {/* panier */}
                    ...
                    <div className="row container-fluid pt-2">
                        ...
                        <div className="d-none d-md-block col-md-auto"><Link className="text-white hover-underline" href={"/"}></Link></div>
                    </div>
                </nav>
        </header>
    );
